export default function Songs() {
  ...
  return (
    <section id="songs" className="w-full px-4 py-16 text-white flex flex-col items-center">
      <h2 className="text-4xl md:text-5xl font-bold mb-8 text-center">My Composed Songs 🎵</h2>
